...
export const loadSVGResources = (ir: MdIconRegistry, ds: DomSanitizer) => {
    ...
    const dirIconsSVG = `${dirImg}icons/`;
    ir.addSvgIcon('volume', ds.bypassSecurityTrustResourceUrl('assets/svg/remind.svg'));
    ir.addSvgIcon('unassigned', ds.bypassSecurityTrustResourceUrl(`${dirAvatarsSVG}unassigned.svg`));
    ...
    ir.addSvgIcon('move', ds.bypassSecurityTrustResourceUrl(`${dirIconsSVG}move.svg`));
    ir.addSvgIcon('add', ds.bypassSecurityTrustResourceUrl(`${dirIconsSVG}add.svg`));
    ir.addSvgIcon('delete', ds.bypassSecurityTrustResourceUrl(`${dirIconsSVG}delete.svg`));
